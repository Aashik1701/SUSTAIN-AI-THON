        ...
        <div className="relative m-auto flex items-center justify-center w-[90%] lg:w-[80%] border-[1px] border-[#72CC5080] rounded-[32px] p-5 md:p-10">
          ...
          <div className="flex items-center justify-center w-full h-full z-[10] text-white">
            <div className="text-white flex flex-col justify-center items-center gap-5 w-[50%] h-full">
              ...
              <span className="m-3">
                <Lock className={"w-[50px] md:w-[70px] lg:w-[80px] max-h-[120px] text-white"} />
              </span>
              <a 
                href={problemStatement} 
                download 
                className="bg-blue-700 text-white py-2 px-4 rounded-lg hover:bg-blue-400 transition-colors"
              >
                Download Problem Statement
              </a>
            </div>  
            <div className="flex flex-col items-center justify-center gap-5 w-[50%] h-full">
              <img src={cittaLogo} className="max-h-[420px] rounded-lg" alt="Citta Logo" /> {/* Updated logo */}
              <h2 className="inter-semibold text-2xl align-middle uppercase tracking-wide">Citta</h2>
              <p className="inter-semibold text-sm lg:text-md sm:text-md max-w-[500px] text-wrap">
